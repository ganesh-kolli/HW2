...
public class SetupAccountPage {
    ...
    public void show(Stage primaryStage) {
        ...
        Button backButton = new Button("Back to Set up/Log in ");
        backButton.setOnAction(e -> new SetupLoginSelectionPage(databaseHelper).show(primaryStage));
        
        VBox layout = new VBox(10);
        layout.setStyle("-fx-padding: 20; -fx-alignment: center;");
        layout.getChildren().addAll(userNameField, passwordField,inviteCodeField, backButton, setupButton, errorLabel);
